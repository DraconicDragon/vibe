...
class BatchLinear(Module):
    def __init__(
        ...
        *,
        ...
        self.weight = Parameter(torch.empty(*batch_shape, out_features, in_features, device=device, dtype=dtype))
...
class LinearHead(Module):
    def __init__(
        ...
        *,
        ...
        self.weight = Parameter(torch.randn(n_classes, input_dim, device=device, dtype=dtype))
...
class SwiGLUHead(Module):
    def __init__(
        ...
        *,
        ...
        self.proj = BatchLinear(n_classes, input_dim, 2, device=device, dtype=dtype)
