"""
ViTDet backbone adapted from Detectron2 / SAM3 / PixAI Labs.
Source: https://huggingface.co/pixai-labs/pixai-tagger-v1.0/blob/main/tagger_pipeline.py
...
class ViTDetClsConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        tags=None,
        tags_split=None,
        tags_best_threshold=None,
        category_best_threshold=None,
        **kwargs,
    ):
        """
        Args:
...
class ViTDetCls(PreTrainedModel):
    ...
    def __init__(self, config: ViTDetClsConfig, *inputs, **kwargs):
        ...
        use_act_checkpoint = config.use_act_checkpoint
        ...
        self.head_pool = MHAttnPool(
            self.embed_dim, self.num_heads, num_patches=(self.img_size // self.patch_size) ** 2, use_pos=True
        )
    ...
    def _init_weights(self, m: nn.Module) -> None:
        ...
        if isinstance(m, Attention) and m.use_rope:
            m._setup_rope_freqs()
